...
class modFlightBook extends DolibarrModules {
    ...
    function modFlightBook($DB) {
        ...
        $this->menu[$r] = array('fk_menu' => 0, // Put 0 if this is a top menu
            ...
            'position' => 15,
            'enabled' => '$user->rights->flightBook->book->list', // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
            'perms' => '$user->rights->flightBook->book->list', // Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
            'target' => '',
        ...
        $this->menu[$r] = array('fk_menu' => 'r=0', // Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
            ...
            'position' => 102,
            'enabled' => '1', // Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
            'perms' => '$user->rights->flightBook->book->edit', // Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
            'target' => '',
            'user' => 2);    // 0=Menu for internal users, 1=external users, 2=both
        // Exports
        $r ++;
